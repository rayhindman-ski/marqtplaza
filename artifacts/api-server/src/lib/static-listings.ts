...
// Den Haag data is sourced from the 24 activity websites listed in denHaagSources.ts,
// crawled in August 2026. Other cities remain lightly curated sample data.

export interface StaticMarker {
  id: string;
  locationId: string;
  category: "Museums" | "Tours" | "Family" | "Entertainment" | "Outdoors" | "Markets";
  name: string;
  description: string;
  x: number;
  y: number;
...
export const MARKERS: StaticMarker[] = [
  ...
  // Tours — sourced from Enter The Hague, seeTheHague, DagjeWeg.NL
  ...
  // Family — sourced from Wannado, FijnUit, DagjeWeg.NL
  ...
  { id: "dhg-f4", locationId: "dhg", category: "Family", name: "Zandkasteel Scheveningen",
    description: "Indoor beach playground for children — slides, sandpits, and splash pools at Scheveningen.",
    x: 12, y: 12, details: "Open daily 10:00–18:00", lat: 52.1030, lng: 4.2720,
    sourceUrl: "https://www.fijnuit.nl" },

  // Entertainment — sourced from Wannado (★4.9 reviewed), FijnUit, Stappen in Den Haag
  { id: "dhg-e1", locationId: "dhg", category: "Entertainment", name: "Escape Room Operation Exit",
    ...
    x: 52, y: 55, details: "Open daily 10:00–23:00", lat: 52.0771, lng: 4.3121,
  ...
  { id: "dhg-e2", locationId: "dhg", category: "Entertainment", name: "Amaze VR Den Haag",
    ...
    x: 52, y: 58, details: "Open Tue–Sun 11:00–22:00", lat: 52.0752, lng: 4.3119,
  ...
  // Outdoors — sourced from DenHaag.com, Reisroutes
  ...
  // Markets — sourced from Wannado, DagjeWeg.NL
  ...
  { id: "m18", locationId: "ein", category: "Museums",       name: "Philips Heritage",     description: "Half price entry to the historic Philips museum.",             x: 50, y: 40, details: "Valid weekends",       lat: 51.4400, lng: 5.4760 },
