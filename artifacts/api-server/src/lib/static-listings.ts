// Static curated listings — served directly by the API (source: "curated").
// All coordinates are WGS-84; x/y are schematic map positions calculated from CITY_BOUNDS.
// x = ((lng - bounds.w) / (bounds.e - bounds.w)) * 100, clamped [5, 95]
// y = ((bounds.n - lat) / (bounds.n - bounds.s)) * 100, clamped [5, 95]
//
// Sources:
//   Amsterdam  — iamsterdam.com, rijksmuseum.nl, vangoghmuseum.nl, artis.nl, heineken.com
//   Rotterdam  — thisisrotterdam.com, boijmans.nl, kunsthal.nl, spido.nl, diergaardeblijdorp.nl
//   Utrecht    — visit-utrecht.com, spoorwegmuseum.nl, speelklok.nl, domtoren.nl
//   Eindhoven  — thisiseindhoven.com, philips-museum.nl, vanabbemuseum.nl, evoluon.com
//   Den Haag   — wannado.nl, fijnuit.nl, enterthehague.com, dagjeweg.nl (crawled Aug 2026)
...
export const MARKERS: StaticMarker[] = [
  ...
  { id: "ams-t1", locationId: "ams", category: "Tours",
    ...
    sourceUrl: "https://www.iamsterdam.com/en/see-and-do/things-to-do/canal-cruises" },
  ...
  { id: "ams-t4", locationId: "ams", category: "Tours",
    name: "Royal Palace Amsterdam Walking Tour",
    ...
    sourceUrl: "https://www.paleisamsterdam.nl/en/" },
  { id: "ams-t5", locationId: "ams", category: "Tours",
    ...
    sourceUrl: "https://www.iamsterdam.com/en/see-and-do/things-to-do/sports-recreation/cycling" },
  ...
  { id: "rot-f3", locationId: "rot", category: "Family",
    ...
    description: "Sleep, dine, or tour the former flagship of the Holland America Line — a floating monument.",
  ...
  { id: "rot-o1", locationId: "rot", category: "Outdoors",
    ...
    sourceUrl: "https://www.thisisrotterdam.com/activities/kralingse-bos" },
  { id: "rot-o2", locationId: "rot", category: "Outdoors",
    name: "Euromast Park & Treetop Walk",
    description: "Landscaped park surrounding the Euromast with a zip line and treetop adventure course.",
    x: 31, y: 70, details: "Treetop walk Apr–Oct, weather permitting", lat: 51.9051, lng: 4.4680,
    sourceUrl: "https://www.euromast.nl/en/klimbos/" },
  ...
  { id: "rot-mk2", locationId: "rot", category: "Markets",
    ...
    description: "Artisan food market in a repurposed warehouse on the Katendrecht peninsula — craft beer and oysters.",
  ...
  { id: "rot-mk3", locationId: "rot", category: "Markets",
    ...
    description: "Weekend market celebrating local makers and vintage finds in Rotterdam's only surviving historic quarter.",
    x: 10, y: 62, details: "Saturday 10:00–17:00", lat: 51.9101, lng: 4.4425,
    sourceUrl: "https://www.thisisrotterdam.com/activities/delfshaven/" },
  ...
  { id: "utr-m3", locationId: "utr", category: "Museums",
    ...
    description: "Self-playing music machines from tiny musical boxes to enormous fairground organs — magical and loud.",
  ...
  { id: "utr-t2", locationId: "utr", category: "Tours",
    ...
    sourceUrl: "https://www.schuttevaer.nl/utrechtse-rondvaart" },
  { id: "utr-t3", locationId: "utr", category: "Tours",
    ...
    x: 26, y: 60, details: "Daily 10:00 & 14:00 from Utrecht Centraal", lat: 52.0894, lng: 5.1106,
    sourceUrl: "https://www.guruwalk.com/walks/33618-free-tour-utrecht" },
  ...
  { id: "utr-f1", locationId: "utr", category: "Family",
    ...
    x: 30, y: 75, details: "Open Tue–Sun 10:00–17:00 (max age 6)", lat: 52.0827, lng: 5.1154,
  ...
  { id: "utr-f3", locationId: "utr", category: "Family",
    ...
    description: "Free children's farm with goats, rabbits, pigs, and vegetable gardens in the heart of the city.",
  ...
  { id: "utr-o1", locationId: "utr", category: "Outdoors",
    ...
    sourceUrl: "https://www.utrecht.nl/wilhelminapark" },
  { id: "utr-o2", locationId: "utr", category: "Outdoors",
    ...
    x: 35, y: 39, details: "Open 24/7, free entry; lido open summer", lat: 52.1005, lng: 5.1176,
    sourceUrl: "https://www.utrecht.nl/griftpark" },
  { id: "utr-o3", locationId: "utr", category: "Outdoors",
    ...
    sourceUrl: "https://www.rvo.nl/amelisweerd" },
  ...
  { id: "utr-mk2", locationId: "utr", category: "Markets",
    ...
    sourceUrl: "https://www.oudegrachtwharves.nl" },
  ...
  { id: "ein-m3", locationId: "ein", category: "Museums",
    name: "DAF Museum",
    description: "Fascinating collection of DAF trucks, vans, and the iconic Daffodil — with a free ride!",
  ...
  { id: "ein-f3", locationId: "ein", category: "Family",
    ...
    sourceUrl: "https://www.thisiseindhoven.com/en/families" },
  ...
  { id: "ein-o1", locationId: "ein", category: "Outdoors",
    ...
    x: 33, y: 83, details: "Open 24/7, free entry; lido open summer", lat: 51.4200, lng: 5.4600,
  ...
  { id: "ein-mk2", locationId: "ein", category: "Markets",
    ...
    x: 21, y: 37, details: "Saturday & Sunday 10:00–17:00", lat: 51.4478, lng: 5.4489,
    sourceUrl: "https://www.strijp-s.nl/events" },
