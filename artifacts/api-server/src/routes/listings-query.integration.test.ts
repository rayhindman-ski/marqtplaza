    ...
    await db.insert(discoveredEventsTable).values([
      {
        ...
        sourceLanguage: "en",
        titleEn: "Centrum community event",
        descriptionEn: "An approved event assigned to Centrum.",
      ...
      },
      {
        ...
        sourceLanguage: "en",
        titleEn: "Unassigned community event",
        descriptionEn: "An approved event without an assigned neighborhood.",
        startsAt: fixtureStartsAt,
        category: "Entertainment",
        lat: 52.109,
        lng: 4.281,
