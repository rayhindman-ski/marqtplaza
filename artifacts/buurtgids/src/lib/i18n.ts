...
export const translations = {
  nl: {
    ...
    selectAllNeighborhoods: 'Selecteer alle buurten',
    clearNeighborhoodSelection: 'Wis selectie',
  ...
  en: {
    ...
    selectAllNeighborhoods: 'Select all neighborhoods',
    clearNeighborhoodSelection: 'Clear selection',
