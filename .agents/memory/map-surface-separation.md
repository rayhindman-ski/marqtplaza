...
Map changes require the full registered `map-regression` validation, not grep-filtered subsets.

**Why:** Partial map checks missed broken cross-surface expectations and stale interaction assertions.